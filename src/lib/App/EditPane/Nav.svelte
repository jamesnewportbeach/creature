<script lang="ts">
  ...
  import { locales, locale, t } from "../../../stores/translations/i18n";
  import {
    userStore,
    focusedStore,
    nodeStore,
  ...
  <ul class="flex w-full pl-0">
    <li class="flex w-full">
      <button
        ...
        class={navItemClass}
        title="Close"
        on:click={API.toggle({ key: "_user/panelOpen" })}
        ><i class="fa-light fa-times" /></button
      >
    </li>
    <li class="flex">
      <select
        bind:value={$locale}
        class="text-xs mr-3 outline-none bg-transparent"
      >
        {#each locales as l}
    ...
    <li class="flex">
      <button
        ...
        ><i
          class={$userStore?.dark ? "fa-regular fa-sun" : "fa-regular fa-moon"}
        /></button
      >
    </li>
    <li class="flex">
    ...
    <li class="flex">
      <button
        ...
        ><i
          class={$userStore?.ruler
            ? "fa-light fa-ruler"
            : "fa-light fa-ruler opacity-50"}
        />
      </button>
    </li>
    <li class="flex">
